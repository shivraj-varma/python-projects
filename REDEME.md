...
A command-line project to manage student records, marks, reports, and JSON export using Python and MySQL.

## Why It Is Good for GitHub

This project shows practical use of Python with databases. It is suitable for beginners who want to demonstrate SQL integration, structured functions, and a real-world CRUD-based mini project in their portfolio.
